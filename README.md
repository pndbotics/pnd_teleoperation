...
Pre-compiled release, no build required. Requires Ubuntu 22.04, ROS 2 Humble, Python 3.10.
...
For developers who need to modify the code or build on a different platform.
...
### Package a release (for maintainers)

After building successfully, create a distributable tarball:

```sh
./scripts/package_release.sh
# Output: release/pnd-teleop-<arch>.tar.gz
```
