...
struct MCPSensorModule_ProcTable {
    ...
    EMCPError (MCP_PROC_TABLE_CALLTYPE * GetSensorModuleFirmwareVersion) (uint32_t * major, uint32_t * minor, uint32_t * revision, uint32_t * build, MCPSensorModuleHandle_t sensorModuleHandle);
};
...
struct MCPJoint_ProcTable {
    ...
    EMCPError (MCP_PROC_TABLE_CALLTYPE * GetJointGlobalRotation) (float * x, float * y, float * z, float * w, MCPJointHandle_t ulJointHandle);
    EMCPError (MCP_PROC_TABLE_CALLTYPE * GetJointGlobalPosition) (float * x, float * y, float * z, MCPJointHandle_t ulJointHandle);
};
...
struct MCPSettings_ProcTable {
    ...
    EMCPError (MCP_PROC_TABLE_CALLTYPE * SetSettingsUDPEx) (const char * localIp, uint16_t localPort, MCPSettingsHandle_t ulSettingsHandle);
};
...
struct MCPApplication_ProcTable {
    ...
    EMCPError (MCP_PROC_TABLE_CALLTYPE * GetAppplicationSystem) (MCPSystemHandle_t * pSystemHandle, MCPApplicationHandle_t ulApplicationHandle);
};
...
struct MCPRobot_ProcTable {
    EMCPError (MCP_PROC_TABLE_CALLTYPE * CreateRobot) (const char * jsonConfigStr, MCPRobotHandle_t * pHandle);
    EMCPError (MCP_PROC_TABLE_CALLTYPE * SetRobotFPS) (int fps, MCPRobotHandle_t handle);
    EMCPError (MCP_PROC_TABLE_CALLTYPE * UpdateRobot) (MCPAvatarHandle_t avatarHandle, MCPRobotHandle_t handle);
    EMCPError (MCP_PROC_TABLE_CALLTYPE * GetRobotRawJointAngle) (EMCPRobotJointType jointType, float * value, MCPRobotHandle_t handle);
    EMCPError (MCP_PROC_TABLE_CALLTYPE * GetRobotRetargetJointAngle) (const char * jointName, float * value, MCPRobotHandle_t handle);
    EMCPError (MCP_PROC_TABLE_CALLTYPE * GetRobotRosFrameJson) (const char ** jsonStr, bool compress, MCPRobotHandle_t handle);
    EMCPError (MCP_PROC_TABLE_CALLTYPE * GetRobotRootRotation) (float * x, float * y, float * z, float * w, MCPRobotHandle_t handle);
